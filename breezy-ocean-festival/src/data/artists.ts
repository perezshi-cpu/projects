...
יאללה קוסטה`,
  ...
  },
  {
    ...
    bio: `אדם גלפנד (ביגיתם) הוא מהקולות הצעירים שדוחפים קדימה את הפסיכדליה המקומית והגיע הזמן ממזמן שבחור מוכשר כמוהו יבוא לחלק אצלנו מתנות ברחבה.

הוא האמן (ביחד עם Detune) מאחורי "Bipolar Bear", טראק שהפך למפלצת רחבות ואין מצב שמישהו ממכם לא שמע אותו בשנתיים האחרונות מפרק רחבה כלשהי.

הסאונד שלו נע על התפר שבין אסיד קלאסי, גואה רטרו ופסיי טראנס – תמהיל שהוא קורא לו "רוטב ביגי" ונשמע חריף ועדכני כי הוא משלב גרוב היפנוטי, סינתים שרוטים ומבנה טראקים לא שגרתי.

הסטים החיים שלו פשוט באים לתת עבודה על הרחבה.

הוא דוחף, הוא מגניב, הוא מפתיע והוא יתן לכם בראש.

עם רזומה של ריליסים ב-Future Music, ב-HOMmega וכחלק מקולקטיב Comet, ביגיתם הוא אחד הצעירים שילוו אותנו שנים קדימה.
...
יאללה אאוטסיידרס`,
  ...
  },
  {
    ...
    bio: `לטעמי, הסטים של אנימטו (פטריק חן) עובדים מעולה ברחבה בגלל האיזון החכם בין המבניות והגרוב של הפרוגרסיב לבין האנרגיה הפסיכדלית של הפסיי-טראנס.

בתור מי שיוצא לו לנגן איתו לא מעט באותם ליינאפים, אני רואה מקרוב איך זה עובד על העמדה: הוא מנגן קצר, חותך ברייקים מהר ומחזיק את הקהל בקצב אינטנסיבי וגבוה לאורך כל הסט.

התוצאה היא מוזיקה קליטה, מדויקת, שמשאירה את הרחבה באנרגיה שמחה ופתוחה בלי לתת לה לנוח.

אחרי שהוציא שלושה אלבומים בפרויקט הקודם שלו (PTX), הוא עשה ריסטארט והמציא את עצמו מחדש כאנימטו. מאז 2012 הוא ממשיך לשייף חתימת סאונד עוצמתית עם מרחב לכל אלמנט.

בתקופה האחרונה הוא מצא בית חם ב-Shamanic Tales (הלייבל של אסטריקס), שחרר שם קטעים מעולים ונמצא חזק בעבודה לקראת האלבום הבא שלו.

פטריק הוא די-ג'יי עם ניסיון ענק שכבר פירק כל במה אפשרית, וכל פעם שהוא ניגן אצלי הרחבה התפוצצה.

הוא יעלה בשיטים לסט שקיעה ב-18:00 כשהחום המדברי נשבר ויקח אותנו אל הלילה השני.

אס בטוח.

יאללה אנימטו`,
    videoUrl: 'https://youtu.be/VR6tCP8dA70?si=XmGm1XayD843AFWM',
  },
  {
    id: '13', name: 'Samra',        origin: 'ישראל', genre: 'פסיטראנס', day: 'Sep 18', stage: 'Main Stage', time: '20:00', photo: '/artists/samra.jpg',
    bio: `טל סמרה עושה פסיי שאולי יושב על אזורים מוכרים, אבל בשורה התחתונה – הוא פשוט עובד מעולה ברחבה. הטראנס שלו עמוס, מלא בשכבות, מנגינות ו-ווקאלים.

הוא ממש לא מפחד להשתמש בעליות גדולות ודרופים שבנויים נטו כדי לפרק.

בשנתיים האחרונות הוא נותן עבודה רצינית בלייבלים כמו Shamanic Tales ו-Iboga. הוא שחרר את "Apex" בסוף 2025, הוציא באפריל האחרון את "Dreamer" יחד עם Adirøs, והרמיקס המעולה שלו ל-"Tuvan" של אנימטו הפך ללהיט רחבות שנוגן בכל מקום.

הסיבה שסגרתי אותו לאירוע היא הכי תכלס שיש: שמעתי אותו מנגן ביום הולדת 50 של אנימטו, והתגובה של הרחבה שם הייתה פשוט אדירה.

הוא ידע בדיוק איך לקחת את כל שאריות האנרגיה שהיו לקהל ולסחוט אותן עד הטיפה האחרונה עם סט סוחף שלא השאיר אף אחד עומד במקום. באותו רגע ידעתי שהוא חייב להיות בליינאפ.

יאללה סמרה`,
    videoUrl: 'https://open.spotify.com/track/54vLD2lQ1AYa9NWuLv2aNy?si=3e618bdd79e84220',
  },
  {
