...
יאללה אאוטסיידרס`,
  ...
  },
  {
    ...
    bio: `מיד כשהוציא ריתמו את האלבום הראשון שלו Disharmonic Silence ב-2008, הוא הפך לאמן בינלאומי מבוקש. חתימת הסאונד הייחודית שלו כבר היתה שם מהרגע הראשון, מלודית ומרגשת משולבת במקצבים מעניינים ובס שמנמן ומפנק.
מעבר להיותו אמן פורה, הוא די ג׳יי מעולה שבכל סט שלו אני חושב לעצמי כמה הכל מהודק מבחינת מיקסים, סאונד ואווירה.
בשנים האחרונות הוא בכושר שיא.
מעבר לאלבום המצוין שלו "Roots" שיצא ב-2023, הוא לא מוריד את הרגל מהגז עם שורת ריליסים ורמיקסים שממשיכים לדחוף את הסאונד שלו קדימה ולקבע את המעמד שלו כאחד האמנים המבוקשים בארץ ובעולם.

מגלה לכם שריתמו הוא אחד האמנים שהקהל מבקש ממני שוב ושוב להביא לנגן והפעם הוא נוחת אצלנו בשיטים ב-07:00 בבוקר — הרגע המושלם שבו הלילה נפרד מהיום.
דובי יביא איתו את הרגש והמלודיה ויסחוף אותנו עם טראנס פותח לבבות.
כל פעם הוא מספק סט לפנתיאון, וגם הפעם זה הולך לשבת בול.
ובנימה אישית, הוא אחד האנשים החמודים והמתוקים בעולם הטראנס.
יאללה ריתמו`,
    videoUrl: 'https://youtu.be/33DlRUi9uNI?si=FxcsARrtRZo9x3Id',
  },
  {
    id: '09', name: 'Space Cat',    origin: 'ישראל', genre: 'פול-און', day: 'Sep 18', stage: 'Main Stage', time: '09:00', photo: '/artists/space-cat.png',
    bio: `אין לי מספיק אוצר מילים להסביר כמה אבי גאון, אבל אני אנסה לתת לכם טעימה.
כבר בתור ילדון בן 17 זכה אבי בתחרות די גיי׳ בינלאומית (על תקליטים כמובן).
יש לו יכולת פסיכית לסנכרן טראקים גם אם אחד ירוץ ממחשב, השני מתקליט והשלישי מפלטה בלי שום בעיה.
פרט טריוויה שחובה לדעת:
הוא אחד האמנים הפוריים בעולם.
הוא חתום על למעלה מ 500 טראקים ורמיקסים שזה מספר פסיכי.
יש לו ידע עצום, יכולת לימוד עצמית וכשרון מטורף.
והמוזיקה….
כמה כיף לרקוד את אבי.
כמה ניגונים שכולכם שרים במקלחת הוא יצר.
עם אינפקטד, לאוד, אסטריקס וכל הטופ העולמי.
תמיד תוכלו למצוא את טביעת האצבע הייחודית לו המתאפיינת בעושר של שכבות, קצב וגרוב מפתיעים ומגניבים, ומלודיות מהממות ומרגשות.
ואחרי כל המחמאות האלו אגלה לכם שהוא האמן הכי צנוע שאני מכיר.
אפס אגו, מאה אחוז אמנות.
מצרף לכם את הסט שלו מהאוזורה, שזה אחד הסטים שהכי כיף לרקוד לטעמי.

החתול ינגן הפעם סט מיוחד של 3 שעות ויעיף אתכם לחלל.
מיאו אבי`,
    videoUrl: 'https://youtu.be/ba8YdkCLFNc?si=Ayj3Y6AHmQxw3o-G',
  },
  { id: '10', name: 'Break',        origin: '',       genre: '12:00 – 16:00',       day: 'Sep 18', stage: 'Main Stage', time: '12:00', isBreak: true },
  {
    ...
    bio: `לירן אלקיים התחיל להוציא מוזיקה אלקטרונית ב-2010, ומאז חרש את העולם עם עשרות ריליסים בלייבלים מובילים שצברו מיליוני השמעות.

הוא מהאנשים שמצהירים שלא באו מ"בית של מוזיקאים" – עובדה שרק דחפה אותו לחקור בעצמו סינתזה ותיאוריה מוזיקלית מחוץ לקופסה.
המוזיקה שלו עמוקה, אלגנטית ומאוזנת מאוד.
אל תחפשו אצלו בילד-אפים קלישאתיים או מלודיות עליזות – מדובר בסאונד מהפנט ואקסטטי שבא לעבוד חכם על הראש ועל הרחבה.
בשנתיים האחרונות הוא במומנטום מטורף.
במרץ 2024 הוא שחרר את האלבום המצוין שלו "Every Mind Is a Place" ב-Iboga Records, שכלל שיתופי פעולה שורטים עם Ritmo, Freedom Fighters ו-Perfect Stranger.

מעבר לזה, החיבור הקרוב שלו עם יולי (Perfect Stranger) עבר פאזה לפרויקט משותף וחדש לגמרי (Perfect Sphera).
באוזורה האחרונה הם כבר עלו להופיע איתו יחד, ולירן מנגן לא מעט חומרים מתוך הפרויקט הזה בסטים העכשוויים שלו, מה שנותן להם זווית חדשה ובועטת.
לירן יעלה אצלנו בשיטים ב-16:00 ויחזיר אותנו מההפסקה בשיא האלגנטיות עם טראנס עמוק, פסיכדלי וחדש.

יאללה ספרה`,
    videoUrl: 'https://youtu.be/ZhAxtoXtpBk?si=4vMoy8GvMPgc25pW',
  },
  {
